$(document).ready(function(){
	...
	if ($('#weather-widget-1').length > 0){
		$("#weather-widget-1").backstretch("/static/demo/assets/img/photo/medium/img-12.jpg");
	}
	if ($('#weather-widget-2').length > 0){
		$("#weather-widget-2").backstretch("/static/demo/assets/img/photo/medium/img-13.jpg");
	}
	if ($('#search-heading').length > 0){
		$("#search-heading").backstretch("/static/demo/assets/img/photo/medium/img-12.jpg");
	}
	if ($('#property-search-wrap').length > 0){
		$("#property-search-wrap").backstretch("/static/demo/assets/img/photo/medium/img-19.jpg");
	}
	/** END BACK STRETCH **/
