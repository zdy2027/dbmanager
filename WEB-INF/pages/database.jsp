...
<html lang="en">
	...
	<body class="tooltips">
				...
				<div class="container-fluid">
					...
					<div class="panel panel-info">
					  	<div class="panel-heading">
							<h3 class="panel-title">数据库基本信息</h3>
					  	</div>
					  	<div class="panel-body">
							<div class="row">
								<div class="col-md-4"></div>
								<div class="col-md-6">
									<button class="btn btn-warning btn-rounded-lg" style="width:80px;" id="backupDBBtn">
										<i class="fa fa-files-o"></i>备份
									</button>
									
									<button class="btn btn-danger btn-rounded-lg" style="width:80px;" id="delDBBtn">
										<i class="fa fa-trash-o"></i>删除
									</button>
									
									<button class="btn btn-info btn-rounded-lg" style="width:80px;" id="recoverDBBtn">
					  		...
					  		<div class="row">
								...
								<div class="col-md-8 text-center">
									<dl class="dl-horizontal">
									  	<dt>数据库名称</dt><dd><s:property value="#request.dbName"/></dd>
									  	<dt>创建时间</dt><dd><s:property value="#request.createTime"/></dd>
									  	<dt>创建人</dt><dd><s:property value="#request.dbUserName"/></dd>
									  	<dt>数据库地址</dt><dd><s:property value="#request.ip"/>:<s:property value="#request.port"/>/<s:property value="#request.dbName"/></dd>
									  	<dt>数据库类型</dt><dd><s:property value="#request.dbType"/><span id="dbid" class="hide"><s:property value="#request.dbid"/></span></dd>
					...
					<div class="panel panel-primary">
					  	...
					  	<div class="panel-body">
					  		<table id="tableList" class="table table-striped" width="100%">
								<thead>
						            <tr>
						            	<th>表名</th>
						                <th>数据记录数</th>
								...
								<tbody>
								<s:iterator value="#request.tableInfos">
						            <tr>
		...
		<!-- BEGIN BACKUPDB SUCCESSINFO PANEL -->
		<div class="modal fade" id="backupSuccessPanel" tabindex="-1" role="dialog" 
		   aria-labelledby="detailLab" aria-hidden="true">
		   <div class="modal-dialog" style="width:40%;min-width:510px;background-color:aliceblue;">
			      <div class="modal-content">
					 <div class="modal-header">
						<h3>备份成功</h3>
					 </div>
			         <div class="modal-body">
						备份文件下载地址<a id="downloadURL">sql文件</a>
			         </div>
		...
		<!-- END BACKUPDB SUCCESSINFO PANEL -->
		
		
		<!-- BEGIN RECOVER FORM -->
		<div class="modal fade" id="recoverFormContainer" tabindex="-1" role="dialog" 
		   aria-labelledby="detailLab" aria-hidden="true">
		   <div class="modal-dialog" style="width:70%;min-width:510px;background-color:aliceblue;">
			      <div class="modal-content">
					 <div class="modal-header">
						<h3>还原数据库</h3>
					 </div>
			         <div class="modal-body">
						<form novalidate="novalidate" enctype="multipart/form-data" id="recoverDBForm" method="post" action="recover" class="form-horizontal bootstrap-validator-form">
							<fieldset>
								<div class="form-group has-feedback">
									<label class="col-md-3 control-label">还原方式</label>
									<div class="col-md-6">
										<select class="form-control" id="recoverType" name="recoverType">
		...
		<script src="assets/databaseAssets/js/database.js"></script>
