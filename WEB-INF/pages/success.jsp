...
<html lang="en">
	...
	<body class="login tooltips">
		...
		<div class="login-wrapper">
			<h4 class="text-center"><i class="fa fa-meh-o icon-square icon-primary"></i>&nbsp;&nbsp;&nbsp;&nbsp;<s:property value="#request.successInfo.info"/></h4>
			<p class="text-center"><strong><a href="<s:property value="#request.successInfo.redirectUrl"/>">回到<s:property value="#request.successInfo.redirectUrlName"/></a></strong></p>
		</div><!-- /.login-wrapper -->
		<!--
		===========================================================
		END PAGE
